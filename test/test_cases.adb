...
--  ----------------------------------------------------------------------------
   ...
   begin
      ...
      Ada.Text_IO.Put_Line("   Time   Position   Velocity");
      t    := 0.0;
      yst0 := 0.0;
      yst1 := 0.0;
      y2   := 5.0;  --  Use as initial y' value
      Ada.Text_IO.Put("  ");
      float_io.Put(t, 2, 2, 0);
      Ada.Text_IO.Put("  ");
      ...
      Ada.Text_IO.New_Line;
      t := step;
      y1 := ode.stormer_start(ode2_f1'Access, t, yst0, y2, step);
      Ada.Text_IO.Put("  ");
      float_io.Put(t, 2, 2, 0);
      Ada.Text_IO.Put("  ");
      float_io.Put(y1, 2, 6, 0);
      Ada.Text_IO.Put("  ");
      float_io.Put((y1 - yst0)/step, 2, 6, 0);
      Ada.Text_IO.New_Line;
      t := t + step;
      yst1 := yst0;
      yst0 := y1;
      for i in 2 .. 20 loop
         y1 := ode.stormer_next(ode2_f1'Access, t, yst0, yst1, step);
         Ada.Text_IO.Put("  ");
         float_io.Put(t, 2, 2, 0);
         Ada.Text_IO.Put("  ");
         float_io.Put(y1, 2, 6, 0);
